...
def run_sanity_check(test_dir):
    ...
    # assert path.isdir(test_dir), FAIL_COLOR+
    # f"No direcotry named {test_dir} found in {os.getcwd()}"
    print(
    ...
    if not test_functions_for_get:
        ...
        if not TEST_FOR_GET_METHOD_RESPONSE_CODE:
            ...
            WARNING_COUNT += 1
            print(
                FAIL_COLOR+"Your test case for GET() does not seem to be "
        ...
        if not TEST_FOR_GET_METHOD_RESPONSE_BODY:
            ...
            WARNING_COUNT += 1
            print(
                FAIL_COLOR+"Your test case for GET() does not seem to be testing "
    ...
    if not test_functions_for_post:
        ...
        print(
            FAIL_COLOR+"Please make sure you have TWO test cases for the POST() method."
        ...
        if not TEST_FOR_POST_METHOD_RESPONSE_CODE:
            ...
            WARNING_COUNT += 1
            print(
                FAIL_COLOR+"One or more of your test cases for POST() do not seem "
    ...
    print(
        WARN_COLOR+"This is a heuristic based sanity testing and cannot guarantee "
        "the correctness of your code."
    )
    print(
        WARN_COLOR+"You should still check your work against the rubric to ensure "
